...
!function () {
  ...
  function updatePnlFromRoi(card) {
    try {
      ...
      // Extract current ROI value
      const roiValue = extractRoiValue(roi);
      ...
      // Get original (unmultiplied) margin if we have it
      const originalMargin = originalMobileMarginValues.get(margin) || (marginValue / MULTIPLIER);
      ...
      if (pnl.textContent !== formattedPnl) {
        ...
        // Update the cached original PNL value
